const termsAndConditionsData = [
	{
		...
		content: [
			'Este sitio web es operado por Softing con nombre comercial Softing. En todo el sitio, los términos “nosotros”, “nos” y “nuestro” se refieren a Softing con nombre comercial Softing ofrece este sitio web, incluyendo toda la información, herramientas y servicios disponibles para ti en este sitio, el usuario, está condicionado a la aceptación de todos los términos, condiciones, políticas y notificaciones aquí establecidos.',
